    ...
    $.getJSON("guitarists.json", function(data){
    	$.each(data, function(key, value){
			...
			var createsPagesWithLinksToVideoClips = '<div data-role="page" id="'+value.id+'"><div data-role="header" data-position="fixed">'+
    												...
    												'<ul id="links" data-role="listview" data-filter="true"><li><a href="#'+
    												array0.number+'" data-rel="popup" data-position-to="window"><img src="'+
    		 										array0.picture+'"></img> '+valuesForArray0+'</a></li>'+
    		 										'<li><a href="#"><img src="'+array1.picture+'"></img> '+valuesForArray1+
    		...
    		$("#linksPages").append( createsPagesWithLinksToVideoClips );
