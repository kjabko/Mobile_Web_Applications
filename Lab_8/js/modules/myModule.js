...
angular.module('myModule', ['ngRoute']).
	...
	config(function($routeProvider){
		...
		$routeProvider.
			...
			when('/', {templateUrl:'js/partials/basic-template.html', controller:'basicController'}).
			when('/urgent', {templateUrl:'js/partials/about.html', controller:'urgentController'}).
	        when('/relax', {templateUrl:'js/partials/contact.html', controller:'relaxController'});
